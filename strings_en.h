...
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>SSID set</strong> to {v}{r}<\br>If you have connection issues, reset password in <strong>info</strong> </div>"; // {c=class} {v=ssid} {r=status_off}
